  ...
  public function assets_monitoring(Request $request){
      ...
      $assets = DB::table('assets as a')
              ->select( 
                        ...
                        'a.code',
                        'a.name as asset_name', 
                        DB::raw("COALESCE(SUM(o.operating_time_to-o.operating_time_from), 0) as total_operating_hours"),
                        DB::raw("COALESCE(SUM(o.distance_travelled_to-o.distance_travelled_from), 0) as total_distance_travelled"),
