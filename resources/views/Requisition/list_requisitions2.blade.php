                          ...
                          <div class="panel panel-default">
                            <div class="panel-body">
                              <form ng-submit="addNew()">
                                <table datatable="ng" class="table table-striped table-bordered" class="tbl_rs_supply">
                                  <thead>
                                    <tr>
                                      <th width="25%">Supply Name</th>
                                  ...
                                  <tbody>
                                    <tr ng-repeat="personalDetail in personalDetails">
                                      <td><select class="form-control select2" ng-model="personalDetail.supply_name" style="width:85%;" required/>
                                        <option selected="selected">Select Suply</option>
                                        <option value="1">Dump Truck tires 3.0</option>
                                        <option value="2">Tire Interior</option>
                                        </select></td>
                                      <td><input type="text" class="form-control" ng-model="personalDetail.supply_desc" disabled="" /></td>
                                      <td><input type="text" class="form-control" ng-model="personalDetail.supply_instock" disabled="" /></td>
                                      <td><input type="text" class="form-control" ng-model="personalDetail.supply_unit" disabled="" /></td>
                                      <td><input type="text" class="form-control" ng-model="personalDetail.supply_qty" required/></td>
                                      <td><input type="text" class="form-control" ng-model="personalDetail.supply_price" required/></td>
                                ...
                                <div class="form-group">
                                  <div class="form-group">
                                    <input type="button" class="btn btn-info pull-right" value="Submit Form" style="margin-right: 10px;">
                                </div>
                                </div>
                              </form>
                            </div>
                                ...
                                <table class="table table-bordered" class="tbl_list_rcpt">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="1"><b>₱500,000.00</b></td>
                                      <td></td>
                                    </tr>
                                  </tbody>
                                </table>
                              ...
                              <form>
                                  ...
                                  <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                      <select class="form-control select2" style="width:100%;" required/>
                                        ...
                                        <option value="1">Erik Super</option>
                                        <option value="2">Erik Pawer</option>
                                      </select>
                                    </div>
                                  ...
                                  <div class="form-group col-sm-12">
                                    ...
                                    <input type="text" class="form-control pull-right" id="">
                                      ...
                                      <div class="form-group">
                                        <div class="form-group">
                                          <input type="button" class="btn btn-info pull-right" value="Save Changes" style="margin-right: 30px;">
                                          <a href="print.html" target="_blank"><button type="button" class="btn btn-info pull-right"  style="margin-right: 10px;"><li class="fa fa-print"></li> Print</button></a>
                                      </div>
                                      </div>
                              </form>
                            </div>
