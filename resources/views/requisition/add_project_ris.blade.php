        ...
        <form class="form-horizontal" id="">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control pull-right" id="datepicker" ng-model="rpc.risDetails.date_requested" datepicker autocomplete="off" readonly="readonly">
            </div></div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group date">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" class="form-control pull-right" id="datepicker2" ng-model="rpc.risDetails.date_needed" datepicker autocomplete="off" readonly="readonly">
            </div></div>
            </div>
            <div class="form-group">
