...
<!-- Basic Details -->
          <div class="col-md-5"> 
            <div class="box">
              ...
              <div class="box-body" style="font-size: 14px;">
                <b>Category:</b> <%amdc.asset.category%><br><br>
    ...
    <div class="col-md-5">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h4 class="box-title"><li class="fa fa-th-large"></li> Application Buttons</h4>
        </div>
        <div class="box-body">
          <a class="btn btn-app">
      ...
      <div class="box"> 
        <div class="box-header with-border">
          <h4 class="box-title"><li class="fa fa-taxi"></li> Operating Data</h4>
        </div>
        <div class="box-body">
    ...
    <div class="col-md-6">
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <img src="{{URL::to('assets/dist/img/sample-depreciate.JPG')}}" width="100%;">
            <table class="table" border="1" width="100%">
              <tr>
                <th colspan="2">Year</th>
                <th>Depreciation expense</th>
                <th>Accumulated depreciation at year-end</th>
