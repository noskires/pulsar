...
<!-- BUTTONS -->
<button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#create-rs" ui-sref="list-projects">
...
<!-- LIST OF PROJECTS  -->     
  <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <div export-to-xlsx data="pc.projects" bind-to-table="'tb-projects'" filename="'List of Projects'"></div>
          <table datatable="ng" class="table table-bordered table-hover" name="tb-projects" width="100%">
            <thead>
            <tr>
              <th>Control No.</th>
              <th>Project ID</th>
