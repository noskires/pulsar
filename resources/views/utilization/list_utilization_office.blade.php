      ...
      <div class="box box-primary">
        ...
        <form id="from-unit" class="form-horizontal" role="form">
          <div class="form-group col-sm-12"">
            <div class="col-sm-3"> 
            <!-- <button type="button" class="btn btn-default" id="daterange-btn" style="width: 100%;" ng-model="uc.utilizationDetails.date_range">
              <span><i class="fa fa-calendar"></i> Select Date Range </span> <i class="fa fa-caret-down"></i>
            </button> -->
              <input type="text" class="form-control pull-right" datepicker2 ng-model="uc.utilizationDetails.date_from" required="" readonly="">
            </div>
            <div class="col-sm-3"> 
              <input type="text" class="form-control pull-right" datepicker2 ng-model="uc.utilizationDetails.date_to" required="" readonly="">
            </div>
            <div class="col-sm-2">

              <select class="form-control select2" style="width: 100%;" ng-model="uc.utilizationDetails.request_type" required="">
            ...
            <div class="col-sm-3">
              ...
              <select class="form-control select2" style="width: 100%;" ng-model="uc.utilizationDetails.reference_code" required="">
            ...
            <div class="col-sm-1">
              <a type="button" class="btn btn-primary btn-flat" ng-click="uc.printUtilizationOfficeDetails(uc.utilizationDetails);uc.toggle()" target="_blank" ng-href="<%uc.url%>">Generate</a></div>
          </div>
        </form>
      </div>
      </div>
