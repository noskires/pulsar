          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-4">
                ...
                <input type="text" class="form-control pull-right" required=""  id="datepicker" ng-model="jo.details.orderDate">
                </div>
              </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <select class="form-control select2" style="width: 100%;" ng-model="jo.details.employee_code" required="" >
                ...
                <option value="<%employee.employee_code%>" ng-repeat="employee in joc.employees"><%employee.fname+' '+employee.lname%></option>
              </select>
              </div>
            </div>
          </div>
...
<div class="">
  ...
  <div class="modal-content">
    ...
    <div class="nav-tabs-custom">
      ...
      <a type="button" class="btn btn-info" ng-click="vm.printJobOrderDetails(vm.formData.jobOrder.job_order_code)" target="_blank" ng-href="<%vm.url%>"><li class="fa fa-print"></li> Print <%vm.formData.jobOrder.job_order_code%> a</a>
