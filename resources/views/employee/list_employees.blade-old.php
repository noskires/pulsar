          ...
          <form id="from-unit" class="form-horizontal" role="form">
            <div class="box-body">
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <input type="number" class="form-control" ng-model="ec.employeeDetails.employeeID" tabindex="1">
                </div>

                <label for="controlnumber" class="col-sm-2 control-label">Suffix</label>
                <div class="col-sm-1"><input type="text" class="form-control" tabindex="5" ng-model="ec.employeeDetails.suffix"></div>

                <label for="dv-payee-type" class="col-sm-1 control-label">Gender</label>
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" ng-model="ec.employeeDetails.lname" required="" tabindex="2">
                </div>
                ...
                <div class="col-sm-4">
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" id="datepicker-bday" ng-model="ec.employeeDetails.bday" datepicker autocomplete="off" tabindex="6">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4"><input type="text" class="form-control" ng-model="ec.employeeDetails.fname" required="" tabindex="3"></div>

                <label for="controlnumber" class="col-sm-2 control-label">Phone Number</label>
                <div class="col-sm-4"><input type="number" class="form-control" ng-model="ec.employeeDetails.phone_no" tabindex="7"></div>
              </div>

              <div class="form-group col-sm-12">
                <label for="controlnumber" class="col-sm-2 control-label">Middle Name</label>
                <div class="col-sm-4"><input type="text" class="form-control" ng-model="ec.employeeDetails.mname" tabindex="4"></div>

                <label for="controlnumber" class="col-sm-2 control-label">Email Address</label>
                <div class="col-sm-4"><input type="text" class="form-control" ng-model="ec.employeeDetails.email" tabindex="8"></div>
              </div>
  ...
  <!-- FILTER DISPLAY -->
    ...
    <div class="box box-primary">
      <div class="box-body">
        ...
        <table datatable="ng" class="table table-bordered table-hover" name="tb-employee" width="100%" style="font-size: 13px;">
          <thead>
          <tr>
            <th>Employee ID</th>
            <th>Last Name</th>
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group date">
                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                          <input type="text" class="form-control" id="emp_sfx" ng-model="vm.formData.date_hired" datepicker autocomplete="off">
                          </div>
                        </div>
                      </div>
